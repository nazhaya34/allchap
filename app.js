...
// var name = [];
// var name = ['haiyan','haya','hannah','hania'];

// var name = {};

// var string=['cat','dog','mouse']

// var number =[2,5,7,35,52,4,5]

// var boolean = [true,false]

// let mixedarr = [ 1. ,'Name', 2,'Class',3.,'Email'];


// let mixedarr = [ 1. ,'SSC', 2,'BSC',3.,'CSS'];

// document.getElementById("demo").innerHTML = mixedarr.join("<br> ");
// console.log(mixedarr)

// var frstname = prompt('First Name');
// var scndName = prompt ('Second Name');
// var a = (frstname + ' ' + scndName);
// alert(a)

// var model = prompt( "enter your frvt mobile model")
// var string = model.length;
// document.getElementById('demo').innerHTML = (model)
// document.getElementById('length').innerHTML=(string)
// console.log(model)
// console.log(string)
...
// var a = prompt("YOUR FARVT BRAND MOBILE")
// var b = a.length
// alert( a)
...
// var a = "KArachi"
// var b = "hydrabad"
// var c = b.replace("hydrabad","Islamabad")
// alert(c)
...
// var model = prompt( "User Input")
// var string = model.toUpperCase();
// document.getElementById('demo').innerHTML = (model)
// document.getElementById('length').innerHTML=(string)
// console.log(model)
// console.log(string)
...
// document.getElementById('demo').innerHTML = (without)
...
// let a = prompt("Enter Positive Integer")
// let b = Math.round(a)
// let c = Math.ceil(a)
// let d = Math.floor(a)

// document.getElementById('Integer').innerHTML =(a);
